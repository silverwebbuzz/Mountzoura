  ...
  function srcAppGlobalLanguageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LanguageService = /*#__PURE__*/function () {
      function LanguageService(translate, api, router) {
        ...
        this.api = api;
        this.router = router;
        this.languagePreference = _storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"].getItem('prefered-language') || 'gr';
        this.languageMenuShow = true;
        translate.addLangs(['en', 'gr']);
        translate.setDefaultLang(_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"].getItem('prefered-language') || 'gr');
        translate.use(_storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"].getItem('prefered-language') || 'gr');
      ...
      _createClass(LanguageService, [{
        ...
        value: function changeLanguage(language) {
          ...
          _storage_service__WEBPACK_IMPORTED_MODULE_3__["StorageService"].setItem('prefered-language', language); // this.router.navigate(["/login"]);
    ...
    var PasswordValidation = /*#__PURE__*/function () {
      ...
      _createClass(PasswordValidation, null, [{
        ...
        value: function MatchPassword(AC) {
          ...
          var confirm_password = AC.get('confirmPassword').value; // to get value in input tag

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["videos-kid-list-kid-list-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppVideosKidListKidListPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppVideosKidListKidListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KidListPageRoutingModule", function () {
      return KidListPageRoutingModule;
    });
    /* harmony import */
    ...
    var _kid_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./kid-list.page */
    ...
    var KidListPageRoutingModule = function KidListPageRoutingModule() {
      _classCallCheck(this, KidListPageRoutingModule);
    };

    KidListPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppVideosKidListKidListModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KidListPageModule", function () {
      return KidListPageModule;
    });
    /* harmony import */
    ...
    var _kid_list_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./kid-list-routing.module */
    "./src/app/videos/kid-list/kid-list-routing.module.ts");
    /* harmony import */


    var _kid_list_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./kid-list.page */
    "./src/app/videos/kid-list/kid-list.page.ts");
    /* harmony import */
    ...
    var KidListPageModule = function KidListPageModule() {
      _classCallCheck(this, KidListPageModule);
    };

    KidListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _kid_list_routing_module__WEBPACK_IMPORTED_MODULE_5__["KidListPageRoutingModule"]],
  ...
  /***/
  function srcAppVideosKidListKidListPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppVideosKidListKidListPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "KidListPage", function () {
      return KidListPage;
    });
    /* harmony import */
    ...
    var KidListPage = /*#__PURE__*/function () {
      function KidListPage(formBuilder, platform, router, iab, api, route, statusBar) {
        _classCallCheck(this, KidListPage);
      ...
      _createClass(KidListPage, [{
        ...
        value: function searchBar(value) {
          var searchList = this.video_result;
        ...
        value: function teacherlessionList(e) {
          ...
          this.api.teacher_lessionlist(e.target.value).subscribe(function (data) {
            _this2.t_lessionlist = data;
            _this2.t_llist = _this2.t_lessionlist.data;
          });
        }
      }, {
        ...
        value: function onChangecourseType(e) {
          ...
          this.api.courselist(e.target.value).subscribe(function (data) {
            _this3.tcourcelist = data;
            _this3.tclist = _this3.tcourcelist.data;
          });
        }
      }, {
        key: "gradList",
        value: function gradList() {
          ...
          this.api.gradeList().subscribe(function (data) {
            _this4.gradlist = data;
            _this4.glist = _this4.gradlist.data;
          });
        }
      }, {
        key: "teacher_list_fb",
        ...
        value: function lessionList() {
          ...
          this.api.lessionlist().subscribe(function (data) {
            _this5.lessionlist = data;
            _this5.llist = _this5.lessionlist.data;
          });
        }
      }, {
        ...
        value: function onChangePropertyType(e) {
          ...
          this.api.courselist(e.target.value).subscribe(function (data) {
            _this6.courcelist = data;
            _this6.clist = _this6.courcelist.data;
          });
        }
      }, {
        ...
        value: function ionViewWillEnter() {
          ...
          this.api.Videolist().subscribe(function (resp) {
            _this7.result = resp;
            _this7.video_result = _this7.result.data; // this.api.dismissLoading();
          });
        ...
        value: function submit() {
          ...
          for (var v in this.video_list_form.controls) {
          ...
          if (this.video_list_form.valid) {
            ...
            this.api.studentVideo(body).subscribe(function (data) {
              _this8.video_process = false;
              ...
              if (data.status == 1) {
                ...
                _this8.router.navigate(["/tabs/video-search"], {
                  queryParams: {
          ...
          if (this.teacher_list_form.valid) {
            ...
            this.api.studentVideo(body).subscribe(function (data) {
              ...
              if (data.status == 1) {
                ...
                _this9.router.navigate(["/tabs/video-search"], {
                  queryParams: {
                    l_id: body.lession_id,
                    c_id: body.course_id,
                    g_id: body.grade_id
    ...
    KidListPage.ctorParameters = function () {
      return [{
    ...
    KidListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-kid-list',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./kid-list.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/videos/kid-list/kid-list.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./kid-list.page.scss */
      "./src/app/videos/kid-list/kid-list.page.scss"))["default"]]
    })], KidListPage);
    /***/
  }
}]);
//# sourceMappingURL=videos-kid-list-kid-list-module-es5.js.map
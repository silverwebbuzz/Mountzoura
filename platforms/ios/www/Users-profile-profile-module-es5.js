...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Users-profile-profile-module"], {
  ...
  /***/
  function srcAppUsersProfileProfileRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUsersProfileProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppUsersProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(formBuilder, router, api, statusBar, navCtrl) {
      ...
      _createClass(ProfilePage, [{
        ...
        value: function onChangePropertyType(e) {
          ...
          this.api.sub_area(e.target.value).subscribe(function (data) {
            ...
            _this2.api.getUserData().subscribe(function (res) {
              _this2.profileData = res;
              _this2.selectedsubId = _this2.profileData.data.sub_area_id;

              _this2.profile_form.patchValue({
                sub_area: _this2.prodata.sub_area_id
              });
            });
          });
        }
        ...
        value: function Details() {
          ...
          this.api.getUserData().subscribe(function (res) {
            if (res) {
              _this3.profileData = res;
              _this3.prodata = _this3.profileData.data;
              _this3.selectedMeasureSetId = _this3.profileData.data.area_id;
              localStorage.setItem("area_id", _this3.profileData.data.area_id);

              _this3.profile_form.patchValue({
                name: _this3.prodata.first_name,
                surname: _this3.prodata.last_name,
                area: _this3.prodata.area_id
              }); // console.log("select_product_image", this.prodata['profile_image'])


              if (_this3.prodata['profile_image']) {
                _this3.select_product_image = _this3.profile_url + _this3.prodata['profile_image'];
              } else {
                _this3.select_product_image = _this3.user_not_found_place_holder;
              }

              _this3.pro_process = false;
        ...
        value: function imageUpload(e) {
          ...
          if (file) {
            ...
            reader.onloadend = function (e) {
              _this4.select_product_image = e.target.result;
            };
        ...
        value: function submit() {
          ...
          if (this.profile_form.valid) {
            ...
            this.api.updateUser(body).subscribe(function (val) {
              _this5.data = val;
              _this5.pro_process = false;

              _this5.api.dismissLoading();

              if (_this5.data.status == 1) {
                if (_this5.data.page == 1) {
                  localStorage.clear();

                  _this5.router.navigate(['/login']);
                }

                if (_this5.data.page == 0) {
                  _this5.api.presentToastWithOptions(_this5.data['message']);

                  _this5.router.navigate(['/tabs/settings']);
                }
              } else {
                _this5.api.presentToastWithOptions(_this5.data['message']);
              }
...
//# sourceMappingURL=Users-profile-profile-module-es5.js.map
...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Home-home-kid-home-kid-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppHomeHomeKidHomeKidPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppHomeHomeKidHomeKidRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HomeKidPageRoutingModule", function () {
      return HomeKidPageRoutingModule;
    });
    /* harmony import */
    ...
    var _home_kid_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./home-kid.page */
    ...
    var HomeKidPageRoutingModule = function HomeKidPageRoutingModule() {
      _classCallCheck(this, HomeKidPageRoutingModule);
    };

    HomeKidPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppHomeHomeKidHomeKidModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HomeKidPageModule", function () {
      return HomeKidPageModule;
    });
    /* harmony import */
    ...
    var _home_kid_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./home-kid-routing.module */
    "./src/app/Home/home-kid/home-kid-routing.module.ts");
    /* harmony import */


    var _home_kid_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./home-kid.page */
    "./src/app/Home/home-kid/home-kid.page.ts");
    /* harmony import */
    ...
    var HomeKidPageModule = function HomeKidPageModule() {
      _classCallCheck(this, HomeKidPageModule);
    };

    HomeKidPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _home_kid_routing_module__WEBPACK_IMPORTED_MODULE_5__["HomeKidPageRoutingModule"]],
  ...
  /***/
  function srcAppHomeHomeKidHomeKidPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppHomeHomeKidHomeKidPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HomeKidPage", function () {
      return HomeKidPage;
    });
    /* harmony import */
    ...
    var _ionic_native_stripe_ngx__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var HomeKidPage = /*#__PURE__*/function () {
      function HomeKidPage(statusBar, stripe, alertCtrl, api, navCtrl, formBuilder, iab, router) {
        _classCallCheck(this, HomeKidPage);
      ...
      _createClass(HomeKidPage, [{
        ...
        value: function ionViewWillEnter() {
          ...
          if (this.role_id == '2') {
            this.api.parentPackageStatus().subscribe(function (resp) {
              _this4.kidstatus = resp; // console.log("testttt", resp)

              if (_this4.kidstatus.status == 1) {
                localStorage.setItem("kid_id", _this4.kidstatus.data.kid_id);
                localStorage.setItem("grade_id", _this4.kidstatus.data.grade_id);
                localStorage.setItem("package_status", _this4.kidstatus.data.package_status);
                localStorage.setItem("amount", _this4.kidstatus.data.price);
                localStorage.setItem("package_id", _this4.kidstatus.data.id);
                localStorage.setItem("packagePurchaseId", _this4.kidstatus.data.packagePurchaseId);
              }
            });
          }
          ...
          this.statusBar.backgroundColorByHexString('#fdf8f1'); // this.api.presentLoading();
          // this.quize_process = true;

          this.api.recentContent().subscribe(function (resp) {
            _this4.quizelist = resp;
            _this4.quizedata = _this4.quizelist.quiz; // this.article = this.quizelist.article;

            _this4.pdf = _this4.quizelist.pdf;
            _this4.video = _this4.quizelist.video; // this.quize_process = false;
            // this.api.dismissLoading();
          });
          this.api.searchPageAdd().subscribe(function (resp) {
            _this4.advertise = resp;
            _this4.add = _this4.advertise.data.image;
            _this4.add_url = _this4.advertise.data.url;
          });
        }
      }, {
        key: "ads",
        ...
        value: function onChangePropertyType(e) {
          ...
          this.api.courselist(e.target.value).subscribe(function (data) {
            _this5.courcelist = data;
            _this5.clist = _this5.courcelist.data;
          });
        }
      }, {
        key: "submit",
        value: function submit() {
          ...
          for (var v in this.home_form.controls) {
          ...
          if (this.home_form.valid) {
            ...
            this.api.studentSearchContent(body).subscribe(function (data) {
              ...
              if (data.status == 1) {
                ...
                localStorage.setItem("k_contain", "k_contain"); // success part
    ...
    HomeKidPage.ctorParameters = function () {
      return [{
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_7__["IonInfiniteScroll"], {
      "static": true
    })], HomeKidPage.prototype, "infiniteScroll", void 0);
    HomeKidPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-home-kid',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./home-kid.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Home/home-kid/home-kid.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./home-kid.page.scss */
      "./src/app/Home/home-kid/home-kid.page.scss"))["default"]]
    })], HomeKidPage);
    /***/
  }
}]);
//# sourceMappingURL=Home-home-kid-home-kid-module-es5.js.map
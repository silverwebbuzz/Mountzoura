...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Quizzes-quiz-kids-quiz-play-quiz-play-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppQuizzesQuizKidsQuizPlayQuizPlayPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppQuizzesQuizKidsQuizPlayQuizPlayRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPlayPageRoutingModule", function () {
      return QuizPlayPageRoutingModule;
    });
    /* harmony import */
    ...
    var _quiz_play_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./quiz-play.page */
    ...
    var QuizPlayPageRoutingModule = function QuizPlayPageRoutingModule() {
      _classCallCheck(this, QuizPlayPageRoutingModule);
    };

    QuizPlayPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppQuizzesQuizKidsQuizPlayQuizPlayModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPlayPageModule", function () {
      return QuizPlayPageModule;
    });
    /* harmony import */
    ...
    var _quiz_play_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./quiz-play-routing.module */
    "./src/app/Quizzes/quiz-kids/quiz-play/quiz-play-routing.module.ts");
    /* harmony import */


    var _quiz_play_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./quiz-play.page */
    "./src/app/Quizzes/quiz-kids/quiz-play/quiz-play.page.ts");
    /* harmony import */
    ...
    var QuizPlayPageModule = function QuizPlayPageModule() {
      _classCallCheck(this, QuizPlayPageModule);
    };

    QuizPlayPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _quiz_play_routing_module__WEBPACK_IMPORTED_MODULE_5__["QuizPlayPageRoutingModule"]],
  ...
  /***/
  function srcAppQuizzesQuizKidsQuizPlayQuizPlayPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppQuizzesQuizKidsQuizPlayQuizPlayPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPlayPage", function () {
      return QuizPlayPage;
    });
    /* harmony import */
    ...
    var QuizPlayPage = /*#__PURE__*/function () {
      function QuizPlayPage(formBuilder, route, api, router, navCtrl, statusBar) {
        _classCallCheck(this, QuizPlayPage);
      ...
      _createClass(QuizPlayPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "quiz_play_fb",
        value: function quiz_play_fb() {
        ...
        key: "checkbox",
        value: function checkbox(e, text, que_id, ans_id, question, que_image, count) {
          var _this = this;
          ...
          this.api.submitAnswer(body).subscribe(function (val) {
            _this.val = val; // this.play_process = false;
            ...
            if (_this.val['status'] == 1 && _this.val['message'] == 'Correct Answer.') {
              if (reqData.countdata) {
                if (val.correct_answer.answer_image) {
                  var ans_img = val.correct_answer.answer_image;
                  _this.play_process = false;
                ...
                _this.router.navigate(['/tabs/quiz-ans-correct'], {
                  queryParams: {
                    countdata: res,
            ...
            if (_this.val['status'] == 1 && _this.val['message'] == 'Wrong Answer.') {
              if (val.correct_answer.answer_image) {
              ...
              var _reqData = _this.route.snapshot.queryParams;
              var res = +_reqData.countdata;

              _this.router.navigate(['/tabs/quiz-ans-wrong'], {
                queryParams: {
                  countdata: res ? res : 0,
        ...
        value: function ionViewWillEnter() {
          ...
          this.api.quizQuestion(reqData.id, body).subscribe(function (resp) {
            _this2.quelist = resp; // console.log(" this.quelist" ,this.quelist.data)
            // this.quelist.data.forEach(element => {
            // });

            _this2.quize_title = _this2.quelist.quiz_title;
            ...
            if (reqData.que_id) {
              ...
              var res = 0;
              res = num + num1; // this.qlist = this.quelist.data.filter(x => x.id == this.qlist[0].id );

              var test = _this2.quelist.data.filter(function (x) {
                return x.count == res;
              }); // console.log("test",test );


              _this2.qlist = test.splice(0, 1);
              _this2.login_process = false;

              _this2.api.dismissLoading();
            } else {
              if (_this2.quelist.data.length !== 0) {
                _this2.qlist.push(_this2.quelist.data[_this2.qlist.length === 0 ? 0 : _this2.qlist[0].id]);

                if (_this2.qlist && _this2.qlist.length >= 2) {
                  _this2.qlist.splice(0, 1); // console.log(this.qlist)
            ...
            var a = _this2.quelist.data.findIndex(function (e) {
              return e.id === _this2.qlist[0].id;
            });

            _this2.len_val = a + 1;
            _this2.len = Number(_this2.len_val);
            localStorage.setItem("len_val", _this2.len);
            _this2.len = _this2.quelist.data.length;
          });
        ...
        value: function back() {
          var reqData = this.route.snapshot.queryParams;
          this.navCtrl.navigateBack(['/tabs/quiz-single'], {
            queryParams: {
              id: reqData.id
            }
          });
    ...
    QuizPlayPage.ctorParameters = function () {
      return [{
    ...
    QuizPlayPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-quiz-play',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./quiz-play.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Quizzes/quiz-kids/quiz-play/quiz-play.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./quiz-play.page.scss */
      "./src/app/Quizzes/quiz-kids/quiz-play/quiz-play.page.scss"))["default"]]
    })], QuizPlayPage);
    /***/
  }
}]);
//# sourceMappingURL=Quizzes-quiz-kids-quiz-play-quiz-play-module-es5.js.map
...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Quizzes-quiz-premium-quiz-premium-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppQuizzesQuizPremiumQuizPremiumPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppQuizzesQuizPremiumQuizPremiumRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPremiumPageRoutingModule", function () {
      return QuizPremiumPageRoutingModule;
    });
    /* harmony import */
    ...
    var _quiz_premium_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./quiz-premium.page */
    ...
    var QuizPremiumPageRoutingModule = function QuizPremiumPageRoutingModule() {
      _classCallCheck(this, QuizPremiumPageRoutingModule);
    };

    QuizPremiumPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppQuizzesQuizPremiumQuizPremiumModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPremiumPageModule", function () {
      return QuizPremiumPageModule;
    });
    /* harmony import */
    ...
    var _quiz_premium_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./quiz-premium-routing.module */
    "./src/app/Quizzes/quiz-premium/quiz-premium-routing.module.ts");
    /* harmony import */


    var _quiz_premium_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./quiz-premium.page */
    "./src/app/Quizzes/quiz-premium/quiz-premium.page.ts");
    /* harmony import */
    ...
    var QuizPremiumPageModule = function QuizPremiumPageModule() {
      _classCallCheck(this, QuizPremiumPageModule);
    };

    QuizPremiumPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _quiz_premium_routing_module__WEBPACK_IMPORTED_MODULE_5__["QuizPremiumPageRoutingModule"]],
  ...
  /***/
  function srcAppQuizzesQuizPremiumQuizPremiumPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppQuizzesQuizPremiumQuizPremiumPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "QuizPremiumPage", function () {
      return QuizPremiumPage;
    });
    /* harmony import */
    ...
    var QuizPremiumPage = /*#__PURE__*/function () {
      function QuizPremiumPage(statusBar, stripe, api, alertCtrl, router, navCtrl, route) {
        _classCallCheck(this, QuizPremiumPage);
      ...
      _createClass(QuizPremiumPage, [{
        ...
        key: "getkid_data",
        value: function getkid_data(kid_id) {
          var _this2 = this;

          this.api.KidData(kid_id).subscribe(function (resp) {
            _this2.kiddata = resp;
            _this2.kidData = _this2.kiddata.data;
            localStorage.setItem("kid_id", _this2.kiddata.data.kid_id);
            localStorage.setItem("grade_id", _this2.kiddata.data.grade_id);
            localStorage.setItem("package_status", _this2.kiddata.package_status);
            localStorage.setItem("amount", _this2.kiddata.package_data.price);
            localStorage.setItem("package_id", _this2.kiddata.package_data.id);
            localStorage.setItem("packagePurchaseId", _this2.kiddata.packagePurchaseId);
            _this2.amount = _this2.kiddata.package_data.price;
          });
        }
      }, {
        ...
        value: function ionViewWillEnter() {
          ...
          localStorage.removeItem("len_val"); // this.kidd_process = true
          // this.api.presentLoading();

          this.api.KidList().subscribe(function (resp) {
            _this3.kidlist = resp;
            _this3.listdata = _this3.kidlist.data; // this.kidd_process = false
                      ...
                      buttons: [{
                        ...
                        handler: function handler(input) {
                          ...
                          if (Number(input.number.length) > 16 || Number(input.number.length) < 16) {
                            _this4.api.showErrorToast('Πληκτρολογήστε 16ψηφία στο πεδίο της κάρτα.');

                            return false;
                          }

                          if (Number(input.month.length) > 2 || Number(input.month.length) < 1) {
                            _this4.api.showErrorToast('Πληκτρολογήστε 2 ψήφία!');

                            return false;
                          }

                          if (Number(input.year.length) > 4 || Number(input.year.length) < 4) {
                            _this4.api.showErrorToast('Πληκτρολογήστε 4 ψήφία!');

                            return false;
                          }

                          if (Number(input.cvc.length) > 4 || Number(input.cvc.length) < 3) {
                            _this4.api.showErrorToast('Πληκτρολογίστε τον 3ψήφιο κωδικό CVC από το πίσω μέρος της κάρτας.');
                          ...
                          _this4.api.presentLoading();

                          _this4.kidd_process = true;

                          _this4.stripe.createCardToken(_this4.card).then(function (token) {
                            ...
                            _this4.api.gradePurchase(body).subscribe(function (data) {
                              _this4.kidd_process = false;
                              ...
                              if (data.status == 1) {
                                ...
                                _this4.router.navigate(['/tabs/kid-added']);
                              } else {
                                _this4.api.presentToastWithOptions(data['message']);
                              }
                            });
                            ...
                            _this4.api.presentToastWithOptions(error);
                          });
                        }
                      }]
                    });
    ...
    QuizPremiumPage.ctorParameters = function () {
      return [{
    ...
    QuizPremiumPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-quiz-premium',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./quiz-premium.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Quizzes/quiz-premium/quiz-premium.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./quiz-premium.page.scss */
      "./src/app/Quizzes/quiz-premium/quiz-premium.page.scss"))["default"]]
    })], QuizPremiumPage);
    /***/
  }
}]);
//# sourceMappingURL=Quizzes-quiz-premium-quiz-premium-module-es5.js.map